...
const Footer: React.FC = () => (
  <footer className="bg-white border-t border-gray-200 pt-10 pb-4 mt-auto">
    ...
    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-center md:justify-between items-center md:items-end mt-8 pt-8 border-t border-gray-200 gap-6">
